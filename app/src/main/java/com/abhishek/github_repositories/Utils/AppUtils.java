...
import static com.abhishek.github_repositories.AppConstants.LANGUAGE_COLOR_MAP;
...
public class AppUtils {
    ...
    public static String getDate(String dateString) {
        ...
        try{
            SimpleDateFormat format1 = new SimpleDateFormat(AppConstants.DATE_TIME_FORMAT, Locale.ENGLISH);
    ...
    public static Pair<View, String>[] getTransitionElements(Context context,
                                               View imageView,
                                               View titleView,
                                               View revealView,
                                               View languageView) {
    ...
    public static int getColorByLanguage(Context context,
        ...
        if(LANGUAGE_COLOR_MAP.containsKey(language)){
            int colorId = LANGUAGE_COLOR_MAP.get(language);
